...
const appCss = "/assets/styles-DVme3gy2.css";
const dict = {
  // Navbar
...
const LangCtx = reactExports.createContext({ lang: "hr", setLang: () => {
}, t: (k) => dict[k]?.hr ?? String(k) });
function LanguageProvider({ children }) {
  const [lang, setLangState] = reactExports.useState("hr");
  reactExports.useEffect(() => {
    try {
...
const useT = () => reactExports.useContext(LangCtx);
...
const Route$6 = createRootRouteWithContext()({
  head: () => ({
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://fonts.googleapis.com/css2?family=Cormorant+Garamond:wght@400;500;600;700&family=Inter:wght@300;400;500;600;700&family=Outfit:wght@300;400;500;600;700;800&display=swap"
      }
    ]
  }),
...
const $$splitComponentImporter$5 = () => import("./projekti-BNOxavzv.js");
const Route$5 = createFileRoute("/projekti")({
  head: () => ({
    meta: [{
      title: "Projekti — Luka Kovačić"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import("./o-meni-DS1k_GxT.js");
const Route$4 = createFileRoute("/o-meni")({
  head: () => ({
    meta: [{
      title: "O meni — Luka Kovačić"
    }, {
      name: "description",
      content: "O meni — Luka Kovačić, student mehatronike i robotike."
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import("./nagrade-nkeuSCMl.js");
const Route$3 = createFileRoute("/nagrade")({
  head: () => ({
    meta: [{
      title: "Nagrade — Luka Kovačić"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import("./kontakt-CwpBzaDZ.js");
const Route$2 = createFileRoute("/kontakt")({
  head: () => ({
    meta: [{
      title: "Kontakt — Luka Kovačić"
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import("./index-CLDq6LkW.js");
const Route$1 = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Portfolio Luke Kovačića — student mehatronike i robotike. Automatizacija, PLC, robotika i razvoj inovativnih strojeva."
    }, {
      property: "og:title",
      content: "Luka Kovačić — Mehatronika i Robotika"
    }, {
      property: "og:description",
      content: "Portfolio inženjerskih projekata, automatizacije i robotike."
    }]
  }),
...
const $$splitComponentImporter = () => import("./projekti._slug-R6Zh-9AE.js");
const Route2 = createFileRoute("/projekti/$slug")({
  head: ({
    params
  }) => ({
    meta: [{
      title: `${titles[params.slug] ?? "Projekt"} — Luka Kovačić`
    }]
  }),
  component: lazyRouteComponent($$splitComponentImporter, "component")
});
const ProjektiRoute = Route$5.update({
  id: "/projekti",
  path: "/projekti",
  getParentRoute: () => Route$6
});
const OMeniRoute = Route$4.update({
  id: "/o-meni",
  path: "/o-meni",
  getParentRoute: () => Route$6
});
const NagradeRoute = Route$3.update({
  id: "/nagrade",
  path: "/nagrade",
  getParentRoute: () => Route$6
});
const KontaktRoute = Route$2.update({
  id: "/kontakt",
  path: "/kontakt",
  getParentRoute: () => Route$6
});
...
const ProjektiSlugRoute = Route2.update({
  id: "/$slug",
  path: "/$slug",
  getParentRoute: () => ProjektiRoute
});
const ProjektiRouteChildren = {
  ProjektiSlugRoute
};
